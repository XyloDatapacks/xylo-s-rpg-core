...
scoreboard players operation @s xrpgc.charms.chest.1 = #xrpgc.skills.get.charms.socket.1.ability_id xrpgc.op
scoreboard players operation @s xrpgc.charms.chest.2 = #xrpgc.skills.get.charms.socket.2.ability_id xrpgc.op
scoreboard players operation @s xrpgc.charms.chest.3 = #xrpgc.skills.get.charms.socket.3.ability_id xrpgc.op
# add charm skills
scoreboard players operation #xrpgc.skills.get.equipment.chest.strength xrpgc.op += #xrpgc.skills.get.charms.strength xrpgc.op
scoreboard players operation #xrpgc.skills.get.equipment.chest.dexterity xrpgc.op += #xrpgc.skills.get.charms.dexterity xrpgc.op
scoreboard players operation #xrpgc.skills.get.equipment.chest.agility xrpgc.op += #xrpgc.skills.get.charms.agility xrpgc.op
scoreboard players operation #xrpgc.skills.get.equipment.chest.constitution xrpgc.op += #xrpgc.skills.get.charms.constitution xrpgc.op
scoreboard players operation #xrpgc.skills.get.equipment.chest.intelligence xrpgc.op += #xrpgc.skills.get.charms.intelligence xrpgc.op
