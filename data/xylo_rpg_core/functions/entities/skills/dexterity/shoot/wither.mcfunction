#> xylo_rpg_core:entities/skills/dexterity/shoot/wither
# @context: wither's projectile
...
scoreboard players set #xproj.position_correction.convert.damage xproj.op 5000
