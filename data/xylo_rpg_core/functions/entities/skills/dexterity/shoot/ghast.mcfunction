#> xylo_rpg_core:entities/skills/dexterity/shoot/ghast
# @context: ghast's projectile
...
scoreboard players set #xproj.position_correction.convert.damage xproj.op 6000
