...
# abilities
data modify storage xylo_rpg_core:data abilities set value [{id:1,name:'{"text":"ability 1"}',rarity:[1,2,3,4,5,6],description:'{"text":"1 to 6"}'},{id:2,name:'{"text":"ability 2"}',rarity:[1,2,3,4],description:'{"text":"1 to 4"}'},{id:3,name:'{"text":"ability 3"}',rarity:[3,4,5,6],description:'{"text":"3 to 6"}'},{id:4,name:'{"text":"ability 4"}',rarity:[4,6],description:'{"text":"4 to 6"}'}]