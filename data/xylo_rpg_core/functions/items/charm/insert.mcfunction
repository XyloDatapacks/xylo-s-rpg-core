#> xylo_rpg_core:items/charm/insert
# @context: any
# @within: any call
...
#
# prepares the storages and scores to call the xylo_rpg_core:items/charm/insert modifier

# get charm data
function xylo_rpg_core:items/charm/insert/start
...
# update charm's socket in temp_item
...
function xylo_rpg_core:items/generate/lore/get_data
