...
scoreboard players operation #xrpgc.items.generate.level xrpgc.op *= #xrpgc.items.generate.rarity xrpgc.op
scoreboard players operation #xrpgc.items.generate.level xrpgc.op /= #6 xconst
