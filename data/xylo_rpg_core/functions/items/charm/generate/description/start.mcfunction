#> xylo_rpg_core:items/charm/generate/description/start
# @context: any
# @within: any call
# @input: "xylo_rpg_core:op skills", "xylo_rpg_core:op requirements"
#
# prepares the storages and scores to call the xylo_rpg_core:items/charm/generate/description/set modifier
...
function xylo_rpg_core:items/charm/generate/description/requirement with storage xylo_rpg_core:op macro_data
...
execute if data storage xylo_rpg_core:op skills run function xylo_rpg_core:items/charm/generate/description/skills with storage xylo_rpg_core:op macro_data
