#> xylo_rpg_core:items/equipment/generate/_item/insert
# @context: any
# @within: xylo_rpg_core:items/equipment/generate/item/start
# @input: "#xrpgc.items.equipment.generate.level xrpgc.op"
#

data modify block 29999999 0 12341232 Items set value []
loot insert 29999999 0 12341232 loot xylo_rpg_core:items/equipment/generate/item/random
