#> xylo_rpg_core:items/equipment/generate/lore/start
# @context: any
# @within: any call
# @input: same outputs as function: xylo_rpg_core:items/equipment/generate/lore/get_data
#
# prepares the storages and scores to call the xylo_rpg_core:items/equipment/generate/lore/set modifier


data remove storage xylo_rpg_core:op lore

execute store result score #xrpgc.items.equipment.generate.rarity xrpgc.op run data get storage xylo_rpg_core:op rarity
execute if score #xrpgc.items.equipment.generate.rarity xrpgc.op matches 1 run data modify storage xylo_rpg_core:op lore.rarity set value {"translate":"item.xylo_rpg_core.generic.lore.rarity.common","color":"white"}
execute if score #xrpgc.items.equipment.generate.rarity xrpgc.op matches 2 run data modify storage xylo_rpg_core:op lore.rarity set value {"translate":"item.xylo_rpg_core.generic.lore.rarity.uncommon","color":"green"}
execute if score #xrpgc.items.equipment.generate.rarity xrpgc.op matches 3 run data modify storage xylo_rpg_core:op lore.rarity set value {"translate":"item.xylo_rpg_core.generic.lore.rarity.rare","color":"blue"}
execute if score #xrpgc.items.equipment.generate.rarity xrpgc.op matches 4 run data modify storage xylo_rpg_core:op lore.rarity set value {"translate":"item.xylo_rpg_core.generic.lore.rarity.epic","color":"light_purple"}
execute if score #xrpgc.items.equipment.generate.rarity xrpgc.op matches 5 run data modify storage xylo_rpg_core:op lore.rarity set value {"translate":"item.xylo_rpg_core.generic.lore.rarity.legendary","color":"gold"}
execute if score #xrpgc.items.equipment.generate.rarity xrpgc.op matches 6 run data modify storage xylo_rpg_core:op lore.rarity set value {"translate":"item.xylo_rpg_core.generic.lore.rarity.mystical","color":"red"}
...
execute store result score #xrpgc.items.equipment.generate.lore.sockets xrpgc.op run data get storage xylo_rpg_core:op sockets
execute if score #xrpgc.items.equipment.generate.lore.sockets xrpgc.op matches 1.. run data modify storage xylo_rpg_core:op lore.socket1 set value [{"text":"[","color":"gray"},{"storage":"xylo_rpg_core:op","nbt":"sockets[0].icon","interpret": true,"color":"white"},{"text":"] ","color":"gray"}]
