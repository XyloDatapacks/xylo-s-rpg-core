#> xylo_rpg_core:items/equipment/generate/requirements/start
# @context: any
# @within: any call
...
#
# prepares the storages and scores to call the xylo_rpg_core:items/equipment/generate/requirements/set modifier
...
scoreboard players operation #xrpgc.items.equipment.generate.skills.total_points xrpgc.op /= #5 xconst
...
scoreboard players operation #xrpgc.items.equipment.generate.skills.average xrpgc.op *= #2 xconst
scoreboard players operation #xrpgc.items.equipment.generate.skills.average xrpgc.op /= #3 xconst
...
scoreboard players operation #xrpgc.items.equipment.generate.skills.assign_min xrpgc.op -= #xrpgc.items.equipment.generate.skills.variance xrpgc.op
execute store result storage xylo_rpg_core:op macro_data.min int 1 run scoreboard players operation #xrpgc.items.equipment.generate.skills.assign_min xrpgc.op > #0 xconst
execute store result storage xylo_rpg_core:op macro_data.max int 1 run scoreboard players get #xrpgc.items.equipment.generate.skills.average xrpgc.op
...
scoreboard players operation #xrpgc.items.equipment.generate.skills.assigned.strength xrpgc.op > #0 xconst
scoreboard players operation #xrpgc.items.equipment.generate.skills.assigned.dexterity xrpgc.op > #0 xconst
scoreboard players operation #xrpgc.items.equipment.generate.skills.assigned.agility xrpgc.op > #0 xconst
scoreboard players operation #xrpgc.items.equipment.generate.skills.assigned.constitution xrpgc.op > #0 xconst
scoreboard players operation #xrpgc.items.equipment.generate.skills.assigned.intelligence xrpgc.op > #0 xconst

# create output
data remove storage xylo_rpg_core:op requirements
execute unless score #xrpgc.items.equipment.generate.skills.assigned.strength xrpgc.op matches 0 store result storage xylo_rpg_core:op requirements.strength int 1 run scoreboard players get #xrpgc.items.equipment.generate.skills.assigned.strength xrpgc.op 
execute unless score #xrpgc.items.equipment.generate.skills.assigned.dexterity xrpgc.op matches 0 store result storage xylo_rpg_core:op requirements.dexterity int 1 run scoreboard players get #xrpgc.items.equipment.generate.skills.assigned.dexterity xrpgc.op
execute unless score #xrpgc.items.equipment.generate.skills.assigned.agility xrpgc.op matches 0 store result storage xylo_rpg_core:op requirements.agility int 1 run scoreboard players get #xrpgc.items.equipment.generate.skills.assigned.agility xrpgc.op 
execute unless score #xrpgc.items.equipment.generate.skills.assigned.constitution xrpgc.op matches 0 store result storage xylo_rpg_core:op requirements.constitution int 1 run scoreboard players get #xrpgc.items.equipment.generate.skills.assigned.constitution xrpgc.op 
execute unless score #xrpgc.items.equipment.generate.skills.assigned.intelligence xrpgc.op matches 0 store result storage xylo_rpg_core:op requirements.intelligence int 1 run scoreboard players get #xrpgc.items.equipment.generate.skills.assigned.intelligence xrpgc.op 
