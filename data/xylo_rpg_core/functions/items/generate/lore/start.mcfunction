...
execute if score #xrpgc.items.generate.rarity xrpgc.op matches 1 run data modify storage xylo_rpg_core:op lore.rarity set value {"text":"Common","color":"white"}
execute if score #xrpgc.items.generate.rarity xrpgc.op matches 2 run data modify storage xylo_rpg_core:op lore.rarity set value {"text":"Uncommon","color":"green"}
execute if score #xrpgc.items.generate.rarity xrpgc.op matches 3 run data modify storage xylo_rpg_core:op lore.rarity set value {"text":"Rare","color":"blue"}
execute if score #xrpgc.items.generate.rarity xrpgc.op matches 4 run data modify storage xylo_rpg_core:op lore.rarity set value {"text":"Epic","color":"light_purple"}
execute if score #xrpgc.items.generate.rarity xrpgc.op matches 5 run data modify storage xylo_rpg_core:op lore.rarity set value {"text":"Legendary","color":"gold"}
execute if score #xrpgc.items.generate.rarity xrpgc.op matches 6 run data modify storage xylo_rpg_core:op lore.rarity set value {"text":"Mystical","color":"red"}
...
execute if score #xrpgc.items.generate.lore.sockets xrpgc.op matches 1.. run data modify storage xylo_rpg_core:op lore.socket1 set value [{"text":"[ ]","color":"gray"}]
execute if score #xrpgc.items.generate.lore.sockets xrpgc.op matches 2.. run data modify storage xylo_rpg_core:op lore.socket2 set value [{"text":"[ ]","color":"gray"}]
execute if score #xrpgc.items.generate.lore.sockets xrpgc.op matches 3.. run data modify storage xylo_rpg_core:op lore.socket3 set value [{"text":"[ ]","color":"gray"}]
