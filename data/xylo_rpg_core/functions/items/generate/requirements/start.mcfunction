...
scoreboard players operation #xrpgc.items.generate.skills.assign_min xrpgc.op -= #xrpgc.items.generate.skills.variance xrpgc.op
execute store result storage xylo_rpg_core:op macro_data.min int 1 run scoreboard players operation #xrpgc.items.generate.skills.assign_min xrpgc.op > #0 xconst
execute store result storage xylo_rpg_core:op macro_data.max int 1 run scoreboard players get #xrpgc.items.generate.skills.average xrpgc.op
...
scoreboard players operation #xrpgc.items.generate.skills.assigned.strength xrpgc.op > #0 xconst
scoreboard players operation #xrpgc.items.generate.skills.assigned.dexterity xrpgc.op > #0 xconst
scoreboard players operation #xrpgc.items.generate.skills.assigned.agility xrpgc.op > #0 xconst
scoreboard players operation #xrpgc.items.generate.skills.assigned.constitution xrpgc.op > #0 xconst
