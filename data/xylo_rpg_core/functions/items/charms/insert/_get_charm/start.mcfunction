#> xylo_rpg_core:items/charms/insert/_get_charm/start
# @context: any
# @within: any call
...
#
# prepares the storages and scores to call the xylo_rpg_core:items/charms/insert/_get_charm/set modifier
